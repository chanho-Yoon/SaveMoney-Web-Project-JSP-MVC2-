...
function inputmoney(tmpno) { 
    ...
    if(money < 0) {
    	...
    	alert("완료");
    	document.location.href='SavingWriteOne.do?no='+tmpno+'&current_amount='+money;
    } else {
    	alert("취소하셨습니다");
    	document.location.href='saving.jsp?no='+tmpno;
    }
    }
</script>
			...
			<div class="inner">
				<header>
					<h1 style="margin-bottom: 0.6em;">
						<a href="saving.jsp" id="logo"><%=vo.getId()%>님의 개인 저축 현황</a>
					</h1>
			...
			<div class="container" style="text-align: center;">
				<div class="row" style="text-align: center;">
					...
					<article class="col-4 col-12-mobile special">
						<a id="img-link"
							href="DeleteSavingOne.do?no=<%=svo.get(i).getNo()%>"><img
							src="images/cancel.png"></a> <a href="#" class="image featured"
						...
						<header>
							<h3 style="margin-bottom: 0.3em">
								<button type="button" onclick="inputmoney(<%=svo.get(i).getNo()%>)">저금</button>
								<%--전에 사용했던방법 <button type="button" onclick="location.href='savinginput.jsp?no=<%=svo.get(i).getNo()%>' ">저금</button> --%>
