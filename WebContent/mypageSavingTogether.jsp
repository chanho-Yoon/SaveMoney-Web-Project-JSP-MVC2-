...
<body>
	...
	<%
		...
		ArrayList<sharesavingVO> svo = dao.sharesavingSelectAllId(loginid);
		//만든이를 알기위해
							...
							<article class="col-4 col-12-mobile special">
								...
								<header>
									...
									<h3 style="margin-top: 0.9em">
										<a href="sharesavingList.jsp?no=<%=svo.get(i).getShareno()%>"><%=svo.get(i).getTitle()%></a>
									</h3>
								</header>
								<p>
									현재 금액 :
