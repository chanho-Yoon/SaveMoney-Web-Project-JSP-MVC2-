...
<body>
	<%
		...
		savememberVO vos = (savememberVO) session.getAttribute("vo");
		String loginid = vo.getId();
		sharesavingDAO daos = new sharesavingDAO();
		ArrayList<sharesavingVO> svos = daos.sharesavingSelectAllId(loginid);
		//만든이를 알기위해
	%>
	<div id="page-wrapper">
		<!-- Nav -->
				...
				<div class="col-8 col-12-mobile imp-mobile" id="content">
					...
					<article id="main">
						...
						<div class="row" style="text-align: center;">
							...
							<article class="col-4 col-12-mobile special">
								<a id="img-link"
									href="mypageDeleteSavingOne.do?no=<%=svos.get(i).getNo()%>"><img
									src="images/cancel.png"></a> <a href="#"
									class="image featured"
									style="text-align: center; margin: 0 0 0.2em 0"> <svg
